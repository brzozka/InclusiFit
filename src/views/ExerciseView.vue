<template>
  <main class="relative w-full h-screen bg-primary">
    ...
    <section
      ...
      class="flex flex-col w-full bg-primary mx-auto bg-white items-center justify-center flex-grow"
    >
      <h2
        id="exercises-title"
        class="flex flex-col text-4xl text-yellow font-bold text-[#655CFE] py-20 px-2"
      >
      ...
      <div class="p-4 text-3xl w-full md:w-[70vw]">
        <input
          ...
          class="p-2 border border-[#655CFE] border-yellow rounded-lg w-full bg-primary"
          aria-label="Search exercises by tags"
        />
        <div class="flex flex-wrap mt-2">
          <button
            ...
            class="bg-[#655CFE] bg-yellow hover-bg-yellow hover:bg-[#201d50] text-white text-b rounded-full px-3 py-1 text-lg font-semibold mr-2 mb-2"
          >
            {{ tag }}
          </button>
        </div>
